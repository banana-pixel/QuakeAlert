...
private fun settingsStringsId(): SettingsStrings = SettingsStrings(
    ...
    showStatus = "Tampilkan Status di Bayangan Notifikasi",
    showStatusDetail = "Ringkasan senyap tentang apakah peringatan dapat mencapai Anda",
    deliveryChecklist = "Daftar Periksa Pengiriman",
    allSet = "Siap: peringatan dapat mencapai Anda",
    ...
    resetBody = "Ini membuat identitas anonim yang benar-benar baru. Nama " +
        "samaran dan ID pengguna Anda saat ini dibuang dan tidak dapat " +
        "dikembalikan. Lokasi dan pendaftaran peringatan Anda dikirim lagi " +
        "atas nama identitas baru.",
    reset = "Setel Ulang",
    ...
    permBackground = "Pengiriman Latar",
    allowed = "Diizinkan",

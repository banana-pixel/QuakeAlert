...
// (store.FCMTokensWithin).
//
// Tidak ada radius yang diterima dari klien: radius peringatan tetap 200 km
// (dispatch.AlertRadiusKm) dengan override intensitas untuk gempa parah. Ini
// keputusan sistem, bukan preferensi — seseorang yang memilih radius sempit
// untuk mengurangi notifikasi tidak akan tahu ia salah sampai gempanya datang.
